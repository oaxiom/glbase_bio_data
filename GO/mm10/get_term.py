...
mapper = glload(os.path.join(os.path.expanduser("~"), "mm10/mm10_ensembl_v79_ensg.glb")).removeDuplicates("ensg")
...
gos_todo = {
    ...
    'GO:0070875': 'positive regulation of glycogen metabolic synthesis',
